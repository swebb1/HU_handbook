...
plot_play(pitch = pitch,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T, base = base) +
  theme_void() +
...
p1 <- plot_play(pitch = pitch,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T) +
...
objects <- list(players,defense,static_objects(object = "Disc",label="Disc",x = 17.5,y = 24.5,show = F,alpha = 1))

p2 <- plot_play(pitch = pitch,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T) +
...
p1 <- plot_play(pitch = pitch,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T, base = base) +
  geom_vline(xintercept = 10, linetype = "dashed", color = "#D15609", alpha = 0.5) +
  geom_text(aes(x=10, y=70, label="Throwing Lane"), color="#D15609", size=2.5, angle = 90, vjust = 1.5, alpha = 0.8) +
  theme_void() +
  coord_fixed(ratio = 0.5) +
...
p2 <- plot_play(pitch = pitch,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T, base = base) +
  geom_vline(xintercept = c(12,22), linetype = "dashed", color = "#D15609", alpha = 0.5) +
  geom_text(aes(x=22, y=70, label="Throwing Lane"), color="#D15609", size=2.5, angle = 90, vjust = 1.5, alpha = 0.8) +
  theme_void() +
  coord_fixed(ratio = 0.5) +
...
p1 <- plot_play(pitch = pitch,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T, base = base) +
  geom_vline(xintercept = c(12,22), linetype = "dashed", color = "#D15609", alpha = 0.5) +
  geom_text(aes(x=12, y=70, label="Throwing Lane"), color="#D15609", size=2.5, angle = 90, vjust = 1.5, alpha = 0.8) +
  theme_void() +
  coord_fixed(ratio = 0.5) +
...
p1 <- plot_play(pitch = pitch,object_list = objects, arrow_list = arrows, pv = ppv, show_all = T) +
  geom_vline(xintercept = 10, linetype = "dashed", color = "#D15609", alpha = 0.5) +
...
objects <- list(players,defense,static_objects(object = "Disc",label="Disc",x = 4,y = 22.5,show = F,alpha = 1,frame = 1:3))
...
#### Launch your attack from a strong position
  ...
  - Find <span style="color: #036d3f;font-weight: bold;">apex points:</span> Positions with multiple attacking options that force your defender into a decision e.g
...
p1 <- plot_play(pitch = pitch,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T) +
  geom_curve(aes(x=5, y=41, xend=3, yend=33), color="#036d3f", linewidth=0.8, arrow=arrow(length=unit(0.2,"cm")),curvature=0) +
    geom_curve(aes(x=5, y=41, xend=10, yend=41), color="#036d3f", linewidth=0.8, arrow=arrow(length=unit(0.2,"cm")),curvature=0) +
    geom_curve(aes(x=15, y=46, xend=15, yend=60), color="#036d3f", linewidth=0.8, arrow=arrow(length=unit(0.2,"cm")),curvature=0) +
    geom_curve(aes(x=15, y=46, xend=10, yend=38), color="#036d3f", linewidth=0.8, arrow=arrow(length=unit(0.2,"cm")),curvature=0) +
    geom_curve(aes(x=15, y=24, xend=10, yend=31), color="#036d3f", linewidth=0.8, arrow=arrow(length=unit(0.2,"cm")),curvature=0) +
    geom_curve(aes(x=15, y=24, xend=18, yend=21), color="#036d3f", linewidth=0.8, arrow=arrow(length=unit(0.2,"cm")),curvature=0) +
  theme_void() +
  coord_fixed(ratio = 0.5) +
  ggtitle("Apex points") +
  theme(plot.title = element_text(size = 10))
...
p1 <- plot_play(pitch = pitch_d,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = F,static_frame = 1,base = base) +
  theme_void() +
  coord_fixed(ratio = 0.75) +
...
objects <- list(players,defense,static_objects(object = "Disc",label="Disc",x = 4,y = 22,show = F,alpha = 1))
...
p1 <- plot_play(pitch = pitch_d,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T, base=base) +
  theme_void() +
  coord_fixed(ratio = 0.5) +
...
p2 <- plot_play(pitch = pitch_d,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T, base=base) +
  theme_void() +
  coord_fixed(ratio = 0.5) +
...
p2 <- plot_play(pitch = pitch_d,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T) +
  geom_vline(xintercept = c(12,25), linetype = "dashed", color = "grey20", alpha = 0.5) +
  theme_void() +
  coord_fixed(ratio = 0.75) +
...
p3 <- plot_play(pitch = pitch_d,object_list = objects, arrow_list = arrows, pv = ppv,show_all = T) +
  geom_vline(xintercept = c(12,25), linetype = "dashed", color = "grey20", alpha = 0.5) +
  theme_void() +
  coord_fixed(ratio = 0.75) +
...
p1 <- plot_play(pitch = pitch_d,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = T) +
  theme_void() +
  coord_fixed(ratio = 0.75) +
...
p2 <- plot_play(pitch = pitch_d,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = F,static_frame = 2, base = base) +
  theme_void() +
  coord_fixed(ratio = 0.75) +
...
p3 <- plot_play(pitch = pitch_d,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = F,static_frame = 3) +
  theme_void() +
  coord_fixed(ratio = 0.75) +
...
p4 <- plot_play(pitch = pitch_d,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = F,static_frame = 4, base = base) +
  theme_void() +
  coord_fixed(ratio = 0.75) +
...
p1 <- plot_play(pitch = pitch_d,object_list = objects, arrow_list = arrows, pv = ppv,keep_arrows = F,static_frame = 1) +
  theme_void() +
  coord_fixed(ratio = 0.75) +
