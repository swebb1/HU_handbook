...
base <- list(
  ...
  geom_text(aes(x=24,y=10,label="Throwing lane"), colour="#D15609", angle = 90, vjust = -0.5, size = 3)
)
...
base <- list(
  geom_hline(aes(yintercept = c(21,5)), colour="#DB127A", linetype="dashed"),
  geom_text(aes(x=33,y=19,label="Swing lane"), colour="#DB127A", vjust = 1.5, size = 3)
)
